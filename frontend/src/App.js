...
function App() {
  ...
  const printLabel = (p) => {
    ...
    w.document.write(`<!DOCTYPE html><html><head><style>
      ...
      ${p.descriptionEN?`<div style="margin-top:4px"><div class="fl">Descripcion (EN)</div><div class="fv" style="font-size:12px">${p.descriptionEN}</div></div>`:""}</div>
            ...
            <div style={{background:"#fff",borderRadius:6,padding:16,color:"#000",boxShadow:"0 4px 20px rgba(0,0,0,0.4)",maxWidth:460,margin:"0 auto"}}>
              ...
              <div style={{borderBottom:"1px solid #ddd",paddingBottom:5,marginBottom:5}}>
                ...
                <div style={{display:"flex",gap:8,alignItems:"center"}}>
                  ...
                  <div><div style={{fontSize:11,fontWeight:600}}>{preview.itemDescription}</div>
                  {preview.descriptionEN&&<div style={{fontSize:9,color:"#666"}}>{preview.descriptionEN}</div>}</div>
                </div>
