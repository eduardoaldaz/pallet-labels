...
function App() {
  ...
  const printLabel = (p) => {
    ...
    w.document.write(`<!DOCTYPE html><html><head><style>
      ...
      <div class="sec"><div class="st">Item</div><div class="row"><div class="f"><div class="fl">Code</div><div class="fv big">${p.itemRefNo||p.itemNo}</div></div><div class="f" style="flex:2"><div class="fl">Description</div><div class="fv">${p.itemDescription||""}</div></div><div class="f"><div class="fl">ETIN/EAN</div><div class="fv" style="font-size:13px">${p.eanCode||"--"}</div></div></div></div>
